...
package com.crazybee.news.util;
...
public abstract class MyAsyncTask<Params, Progress, Result> {
    ...
    private static final int CORE_POOL_SIZE = 1;//5
    private static final int MAXIMUM_POOL_SIZE = 40;//128
    private static final int KEEP_ALIVE = 1;

//    private static final BlockingQueue<Runnable> sWorkQueue =
//            new LIFOLinkedBlockingDeque<Runnable>(10);
    private static final BlockingQueue<Runnable> sWorkQueue =
	...
	public static void destoryClearQueue() {
		sWorkQueue.clear();
